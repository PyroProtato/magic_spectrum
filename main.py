...
class GameScreen:
  ...
  def __init__(self, difficulty):
    ...
    #Hard
      ...
      self.difficulty_money_multiplyer = 1
      self.rounds.append({"green":1, "red":1}) #ROUND 1
  ...
  def run(self, events):
    ...
    if self.settings_button.check_press(self.mousePos, self.mouseUp):
      return "sets"
    ...
    if not self.in_shop and not self.in_info:
      ...
      if self.shop_button.check_press(self.mousePos, self.mouseUp) and not self.in_info:
        self.in_shop = True
        self.camera_x_change, self.camera_y_change = 0, 0
        self.shop_notifications_on = False
        pygame.mouse.set_visible(True)
      ...
      if self.info_button.check_press(self.mousePos, self.mouseUp) and not self.in_shop:
        self.in_info = True
        self.camera_x_change, self.camera_y_change = 0, 0
        game_sound_channel.play(info_open_sound)
        #pygame.mixer.Sound.play(info_open_sound)
      ...
      #Player Movement
      if self.w_down or self.d_down or self.s_down or self.a_down:
